...
def check_for_essid(essid, l_ist):
    check_status = True
...
#user interface the user will first see this
print(r"""
...
print("\n* i will not be held responsible if you are caught using this script for malicious intends                 *")
...
#to break this script press the Contol + c on the keyboard
